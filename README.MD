...
| Mode        | Spring Boot Runtime | Database                 | Message Broker       | Configuration Source          |
|-------------|--------------------|--------------------------|----------------------|------------------------------|
| Development | Run from IDE       | PostgreSQL (Docker)      | RabbitMQ (Docker)    | IDE Environment Variables     |
